...
*May 9, 2026 — Updated `api/shows` route with middleware to automatically trigger `updateShowStatuses` on every request as a fallback for missed cron jobs in production.*
