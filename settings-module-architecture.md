...
| `src/pages/settings/GeneralSettingsPage.jsx` | Rewritten: uses `SettingsPageHeader` + `SettingsCard` + inline `Globe`/`Coins`/`Languages` icons + `h-11` inputs + full-width `space-y-6` layout (`a8796a4`) |
